...
\newcommand{\keywordsRu}{алгоритм Манакера, палиндромные подстроки, JavaScript, Node.js, модульное тестирование, TDD} % ВВЕДИТЕ ключевые слова по-русски
\newcommand{\abstractRu}{В работе рассматривается разработка консольного приложения на JavaScript для поиска палиндромных подстрок в строке с использованием алгоритма Манакера. Исследуемая задача относится к классу задач обработки строк и требует эффективного определения палиндромов нечётной и чётной длины. В отчете описаны постановка задачи, проектирование архитектуры приложения, выбор средств модульного тестирования и применение подхода разработки через тестирование. Для проверки корректности решения используются методы разбиения на классы эквивалентности, анализа граничных значений, тестирования операторов и тестирования ветвей. Приводится описание реализации на платформе Node.js, структуры основных модулей, а также результаты мутационного тестирования. Полученные результаты подтверждают корректность реализации алгоритма Манакера и достаточное качество тестового набора.}
%
